...
nimagenesseg=float(len(nombrestrain))
...
for o in nombrestrain:
    ...
    #Definimos las 3 dimensiones de estos arrays
    cantidadimagenes=listagmm.shape[0]
    cantidadfilas=listagmm.shape[1]
    cantidadcolumnas=listagmm.shape[2]
    #Definimos una lista con estas dimensiones
    dimensiones=[cantidadimagenes,cantidadfilas,cantidadcolumnas]
    #Ahora vuelvo esto un array 2D donde cada fila tiene una segmentacion
    listakmeans=listakmeans.reshape(cantidadimagenes,cantidadfilas*cantidadcolumnas)
    listagmm=listagmm.reshape(cantidadimagenes,cantidadfilas*cantidadcolumnas)
    
    np.savetxt("./missegmentaciones/Training/kmeans/"+str(o)+".mat",listakmeans)
    np.savetxt("./missegmentaciones/Training/gmm/"+str(o)+".mat",listagmm)
    np.savetxt("./missegmentaciones/Training/dimensiones/"+str(o)+".mat",np.array(dimensiones))
...
#for o in nombrestest:
    ...
    #np.savetxt("./missegmentaciones/Test/dimensiones/"+str(o)+".mat",np.array(dimensiones))
    #contadorima=contadorima+1
    #print(float(contadorima/nimagenesseg)*100.0)
...
#for o in nombresval:
    ...
    #np.savetxt("./missegmentaciones/Validation/dimensiones/"+str(o)+".mat",np.array(dimensiones))
    #contadorima=contadorima+1
    #print(float(contadorima/nimagenesseg)*100.0)
