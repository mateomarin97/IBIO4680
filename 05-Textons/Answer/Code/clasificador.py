...
np.savetxt("Histograma.dat",np.array(histPlaidTra))
...
np.savetxt("Confu_"+"k="+str(k)+"_Pixel="+str(Npix)+".dat",confu)
...
#Guardamos la matriz normalizada
np.savetxt("Confunor_"+"k="+str(k)+"_Pixel="+str(Npix)+".dat",confu)
#Calculamos el ACA
ACA=0
for i in range(25):
    ACA=ACA+confu[i][i]
